...
- Projekt som omfattade hela organisationen
...
- Projekt som omfattade "ultra-high net-worth"-kunder
- Utvecklade schemalagda jobb för dataintegration mot RPA-system (Robotic Process Automation)
...
- Kurser inom webbutveckling med React.js och backend-integration via API:er
- Praktisk erfarenhet av fullstack-utveckling
- LIA (praktik) på Försvarsmakten och Artportable AB
